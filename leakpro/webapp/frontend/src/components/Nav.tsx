...
export default function Nav({ onToggleDark, dark }: NavProps) {
  return (
    <header className="border-b border-slate-200 dark:border-surface-border bg-background-light dark:bg-background-dark px-6 py-4 shrink-0">
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="p-2 hover:bg-slate-200 dark:hover:bg-surface-2 rounded-lg transition-colors"
