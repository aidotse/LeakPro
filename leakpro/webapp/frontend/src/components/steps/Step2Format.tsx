    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex justify-end">
        <button
          onClick={confirm}
          disabled={loading}
          className="px-8 py-2.5 rounded-lg bg-slate-700 text-cream border border-primary font-bold hover:bg-slate-600 transition-colors flex items-center gap-2 shadow-lg shadow-black/30 disabled:opacity-50"
        >
