...
export const STEPS = [
  ...
  { label: "Model Training", icon: "psychology" },
          ...
          >
            <div
              className={`size-10 rounded-full flex items-center justify-center ring-4 ring-background-light dark:ring-background-dark transition-all
                ${active ? "bg-slate-700 text-cream border border-primary" : done ? "bg-primary/20 text-primary" : "bg-slate-200 dark:bg-slate-800 text-slate-500"}`}
            >
              {done ? (
