...
from leakpro.optimization import AttackScores, PETRecipe, build_campaign_fns, confidence_logits, train_with_dpsgd
...
class TestConfidenceLogits:
    def test_multiclass_prefers_true_class(self):
        ...
        phi = confidence_logits(model, x, y, "cpu", output_kind="logits")
        y_wrong = (y + 1) % 3
        phi_wrong = confidence_logits(model, x, y_wrong, "cpu", output_kind="logits")
    ...
    def test_binary_probs_symmetry(self):
        ...
        phi = confidence_logits(model, p, y, "cpu", output_kind="binary_probs")
    ...
    def test_binary_logits_signed_by_label(self):
        ...
        y = torch.tensor([[1.0], [0.0]])
        phi = confidence_logits(model, logit, y, "cpu", output_kind="binary_logits")
