...
class AttackObjects:
    def __init__(self, population: Dataset, train_test_dataset, target_model: Model, configs: dict):
        ...
        self._audit_dataset = {
            ...
            "data": np.concatenate((train_test_dataset["train_indices"], train_test_dataset["test_indices"])),
            ...
            "out_members": np.arange(len(train_test_dataset["train_indices"]), len(train_test_dataset["train_indices"]) + len(train_test_dataset["test_indices"])),
        }
