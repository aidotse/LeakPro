...
class MIAResult:
    ...
    def __init__(  # noqa: PLR0913
        ...
        sorted_indices = np.argsort(-np.ravel(signal_values))
        sorted_labels = self.true[sorted_indices]
        sorted_scores = signal_values[sorted_indices]
    ...
    def save(self:Self, path: str, name: str, config:dict = None) -> None:
        ...
        mia_data = MIAResultSchema(
            ...
            true = self.true.tolist() if self.true is not None else None,
            id = self.id,
        )
