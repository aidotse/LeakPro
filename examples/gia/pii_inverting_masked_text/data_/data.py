...
def pre_process_data(
        ...
        tokenized_batch = tokenizer(texts, add_special_tokens=True, return_offsets_mapping=True)
        ...
        for ix in range(len(tokenized_batch.encodings)):
            ...
            raw_annotations = annotations[ix]
...
class TrainingBatch:
    ...
    def __init__(self, examples: List[TrainingExample]):
        ...
        for ex in examples:
            ...
            embedding.append(ex.embedding)
        #self.input_ids = torch.LongTensor(input_ids)
        self.embedding = torch.stack(embedding) 
