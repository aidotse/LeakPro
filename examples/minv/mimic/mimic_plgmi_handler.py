...
class Mimic_InputHandler(AbstractInputHandler):  # noqa: N801
    ...
    def train_gan(self,
                    ...
                    gen: torch.nn.Module,
                    dis: torch.nn.Module,  # noqa: ARG002
                    gen_criterion: callable,
                    dis_criterion: callable,
                    inv_criterion: callable,
                    target_model: torch.nn.Module,
                    opt_gen: optim.Optimizer,  # noqa: ARG002
                    opt_dis: optim.Optimizer,  # noqa: ARG002
                    n_iter: int,
                    n_dis: int,
                    device: torch.device,
                    alpha: float,
