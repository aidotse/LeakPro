...
-- sepsis
\echo 'Creating sepsis...'
\i sepsis/angus.sql
\i sepsis/explicit.sql
\i sepsis/martin.sql

-- -- diagnosis
-- \echo 'Creating diagnosis...'
-- \i diagnosis/ccs_dx.sql

-- organfailure
\echo 'Creating organfailure...'
